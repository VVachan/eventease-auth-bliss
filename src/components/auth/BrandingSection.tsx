...
export const BrandingSection = () => {
  return (
    <div className="relative h-full overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[hsl(270,40%,12%)] via-[hsl(270,50%,18%)] to-[hsl(280,40%,15%)]" />
      
      {/* Animated orbs - Purple and Gold */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 -left-20 w-96 h-96 bg-[hsl(270,65%,55%)]/15 rounded-full blur-[120px] animate-pulse-slow" />
        <div className="absolute bottom-1/4 right-0 w-80 h-80 bg-[hsl(45,90%,55%)]/15 rounded-full blur-[100px] animate-pulse-slow" style={{ animationDelay: "1s" }} />
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-[hsl(280,70%,60%)]/10 rounded-full blur-[80px] animate-pulse-slow" style={{ animationDelay: "2s" }} />
      </div>
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center p-8 lg:p-12 xl:p-16 text-center">
        ...
        <div className="space-y-4 animate-slide-up max-w-md" style={{ animationDelay: "0.2s" }}>
          <h1 className="text-3xl lg:text-4xl xl:text-5xl font-display font-bold leading-tight text-primary-foreground">
            Create
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[hsl(270,65%,65%)] to-[hsl(45,90%,60%)]"> unforgettable </span>
            experiences
          </h1>
